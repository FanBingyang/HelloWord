...
<div><br/><br/>
    <marquee behavior="scroll" height="20" width="900" direction="left" scrollamount="5" vspace="0px" onmouseover=this.stop() onmouseout=this.start() >
        <span style="font-size: 12px">欢迎你：<%=request.getSession().getAttribute("username")%>同学！</span></marquee>
</div>
</body>
</html>
