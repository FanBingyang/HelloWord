...
public class CancelWoker extends JPanel implements ActionListener{
	private JLabel l1;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==ok){
			...
			try {
				...
				String sql="DELETE FROM employee  where id='"+t1.getText()+"'";
				String sql2="select * from employee  where id='"+t1.getText()+"'";
				rs=stmt.executeQuery(sql2);
				if(rs.next())
				{
					stmt.executeUpdate(sql);
				JOptionPane.showMessageDialog(null, "员工注销成功！");
				stmt.close();
				con.close();
