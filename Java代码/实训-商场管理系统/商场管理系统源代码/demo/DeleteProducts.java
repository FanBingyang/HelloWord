...
public class DeleteProducts extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==ok){
			if(t1.getText().isEmpty())
				JOptionPane.showMessageDialog(null, "商品的编号不能为空！");
			else
			try {
			...
			try {
				...
				String sql="DELETE FROM 商品总表  where 编号='"+t1.getText()+"'";
				String sql2="select * from 商品总表  where 编号='"+t1.getText()+"'";
