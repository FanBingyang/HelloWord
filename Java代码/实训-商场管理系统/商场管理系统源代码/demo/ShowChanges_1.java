...
public class ShowChanges_1 extends JPanel implements ActionListener{
	private JLabel l;
	private JButton b;
	private JTextField t;
	private String s;
	public  ShowChanges_1() {
		// TODO Auto-generated constructor stub
		
		this.setLayout(null);
		this.setBounds(0,0,780,620);
		l=new JLabel("    请输入你要修改的VIP账号");
...
//		this.add(table);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b){
			...
			String sql="select * from vip  where id='"+t.getText()+"'";
